...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.resize(700, 100)
        Form.setMinimumSize(QtCore.QSize(700, 100))
        Form.setMaximumSize(QtCore.QSize(700, 100))
        Form.setStyleSheet("")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_39.setText(_translate("Form", "<html><head/><body><p>Эффективная годовая ставка:</p></body></html>"))
